               ...
               <tr>
                  ...
                  <td>
                     <input type="text" id="id"
                        name="Repository ID" size="16" value="owlim" />
                  </td>
                  <td></td>
               </tr>
               <tr>
                  ...
                  <td>
                     <input type="text" id="title"
                        name="Repository title" size="48" value="Sample Owlim Repository" />
                  </td>
                  <td></td>
               </tr>
               ...
               <tr>
                  ...
                  <td>
                     <select name="Ruleset">
						...
						<option id="customRulesetOption" value="../applications/ontotext_owlim/Rules_custom.pie" selected="true">Select a Ruleset (.pie) file</option>
                     </select>
