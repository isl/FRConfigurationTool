         ...
         <table class="dataentry">
            <tbody>
               ...
               <tr>
                  ...
                  <td>
                     <input type="text" id="id"
                        name="Repository ID" size="16" value="BigOWLIM" />
                  </td>
                  <td></td>
               </tr>
               <tr>
                  ...
                  <td>
                     <input type="text" id="title"
                        name="Repository title" size="48" value="Sample BigOWLIM Repository" />
                  </td>
                  <td></td>
               </tr>
               ...
               <tr>
                  ...
                  <td>
                     <select name="Repository type">
                        <option value="file-repository" selected="true">File</option>
                        <option value="in-memory-repository">In-Memory</option>
               ...
               <tr>
                  ...
                  <td><!-- ruleset option doesn't work. It is set in ttl or in JAVA_OPTS -->
                     <select name="Ruleset">
                        <option value="rdfs">RDFS</option>
                        <option value="owl-horst">OWL/Horst</option>
                        <option value="owl-max">OWL/Max</option>
						<option id="customRulesetOption" value="../ontotext_owlim/Rules_custom_big.pie" selected="true">Select a Ruleset (.pie) file</option>
                     </select>
