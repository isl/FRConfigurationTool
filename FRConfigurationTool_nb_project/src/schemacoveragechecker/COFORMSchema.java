...
public class COFORMSchema {
    ...
    public ArrayList<String> addPrefixInsteadOfFullNameSpace(ArrayList<String> propertiesList) {
        ...
        for (String prop : propertiesList) {
            ...
            if (prop.startsWith("http://www.ics.forth.gr/isl/rdfs/3D-COFORM_CIDOC-CRM.rdfs#")) {
                prop = prop.replaceAll("http://www.ics.forth.gr/isl/rdfs/3D-COFORM_CIDOC-CRM.rdfs#", "crm:");
            } else if (prop.startsWith("http://www.ics.forth.gr/isl/rdfs/3D-COFORM_CRMdig.rdfs#")) {
                prop = prop.replaceAll("http://www.ics.forth.gr/isl/rdfs/3D-COFORM_CRMdig.rdfs#", "crmdig:");
            }
